...
public class tela2 extends AppCompatActivity {
    ...
    public void calcular(View view) {
        ...
        if (TextUtils.isEmpty(editPeso.getText().toString())) {
            editPeso.setError("faltou digitar o peso");
            editPeso.requestFocus();
        } else if (TextUtils.isEmpty(editAltura.getText().toString())) {
            editAltura.setError("faltou digitar a altura");
            ...
            // Jogando os resultados para terceira tela que é o status do IMC.
